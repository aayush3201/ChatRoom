...
/**
 * A ChatRoomClient represents a client which joins a room by connecting to a
 * ChatRoomServer.
...
public class ChatRoomClient {
    ...
    public ChatRoomClient(String hostname, int port, String name) throws IOException {
        ...
        userName = (name != null && !name.equals("")) ? name
                : "user" + Long.toString(System.currentTimeMillis() % 1000);
    ...
    /**
     * An instance of MessageGetter is responsible for receiving messages sent out
     * by
    ...
    /**
     * An instance of MessageSender is responsible for sending the current client's
     * messages
