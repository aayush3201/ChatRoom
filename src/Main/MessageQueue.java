...
/**
 * A MessageQueue is a thread-safe queue which stores messages till they are
 * read and discards them once they are
 * read using the First in First out (FIFO) principle. Ensures that a message is
 * read by the same number of people
...
public class MessageQueue {
     ...
     * 
     * @param alreadyRead represents a set of clients who have already read the
     *                    message
     */
