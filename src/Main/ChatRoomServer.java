...
/**
 * A ChatRoomServer instance represents a server which acts like a room. The
 * users that have
...
public class ChatRoomServer {
    ...
    /**
     * An instance of MessageReceiver acts as a medium to receive messages on
     * separate threads
     */
    private class MessageReceiver implements Runnable {
         ...
         * @param in     the reader which reads messages incoming in the form of a
         *               stream
         */
     ...
     * @param alreadyRead A set of numbers which represents the messages already
     *                    displayed to
